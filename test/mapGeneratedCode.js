...
var should_map_code_with_many_lines_in_time = require('../native').should_map_code_with_many_lines_in_time;
...
describe("mapGeneratedCode", function() {
	...
	it("should map code with many lines in time", function() {
		...
		var result = newMap.toStringWithSourceMap({ file: "test.txt" });
		var r = should_map_code_with_many_lines_in_time({ file: "test.txt" });
